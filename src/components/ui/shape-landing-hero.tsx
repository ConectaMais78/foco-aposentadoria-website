            ...
            >
                <div
                    className={cn(
                        ...
                        "shadow-[0_8px_32px_0_rgba(255,127,17,0.15)]",
                        "after:absolute after:inset-0 after:rounded-full",
                        "after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,127,17,0.2),transparent_70%)]"
                    )}
                />
            </motion.div>
        </motion.div>
...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-deepNavy">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    height={120}
                    rotate={-15}
                    gradient="from-orangeLight/[0.15]"
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-playfair font-bold mb-6 md:mb-8 tracking-tight leading-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-orange via-white/90 to-orangeLight"
                                )}
                            >
                                {title2}
                            </span>
